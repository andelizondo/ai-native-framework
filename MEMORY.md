...
- For this repository, CodeRabbit should be allowed to start automatically; manual `@coderabbitai review` comments are a recovery path for a stalled reviewer, not part of normal PR flow.
